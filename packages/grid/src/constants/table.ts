...
export const AI_TABLE_ROW_GROUP_COLLAPSE_BUTTON = 'AI_TABLE_ROW_GROUP_COLLAPSE_BUTTON';
...
export const AI_TABLE_CELL_MULTI_SELECT_ITEM_TAG_MIN_WIDTH = 40; // 多选字段项的tag最小宽度

export const AI_TABLE_CELL_MULTI_SELECT_ITEM_PIECE_MIN_WIDTH = 55; // 多选字段项的tag最小宽度

export const AI_TABLE_CELL_MULTI_SELECT_ITEM_DOT_MIN_WIDTH = 55; // 多选字段项的tag最小宽度

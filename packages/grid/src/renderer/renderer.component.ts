...
import { AITableExpandRecord } from './components/expand-record.component';
import {
...
export class AITableRenderer {
    ...
    showExpandRecordIcon = computed(() => {
        return !!this.config()?.aiTable.context?.aiFieldConfig()?.showExpandRecordIcon;
    });
